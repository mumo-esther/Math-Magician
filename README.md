<a name="readme-top"></a>
![](https://img.shields.io/badge/MATHMAGICIAN-pinkviolet)
...
- Open terminal
- Clone this project by the command `git clone https://github.com/mumo-esther/Math-Magician.git`
- `cd <clone>` folder
...
cd my-folder
git clone https://github.com/mumo-esther/Math-Magician.git
